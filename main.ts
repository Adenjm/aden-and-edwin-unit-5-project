...
let Muslim: Sprite = null
let text_list: string[] = []
let American: Sprite = null
let myDart: Dart = null
let number = game.askForNumber("Pick a number between 1 and 2")
...
if (number == 1) {
    ...
    for (let value of text_list) {
        American.sayText(value)
        pause(600)
    }
    American.setPosition(132, 63)
} else {
    Muslim = sprites.create(img`
        . . . . . . 5 . 5 . . . . . . . 
        . . . . . f 5 5 5 f f . . . . . 
        . . . . f 1 5 2 5 1 6 f . . . . 
        . . . f 1 6 6 6 6 6 1 6 f . . . 
        ...
        . . . . . f f . . f f . . . . . 
        `, SpriteKind.Enemy)
    text_list = ["allah", "ak", "bar"]
    for (let value of text_list) {
        Muslim.sayText(value)
        pause(600)
    }
    Muslim.setPosition(132, 63)
}
